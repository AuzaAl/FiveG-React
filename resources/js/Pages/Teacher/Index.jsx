...
export default function Index() {
    const { teachers, flash, filters } = usePage().props;
    ...
    const confirmDelete = () => {
        if (selectedTeacherId) {
            router.delete(`/dashboard/teachers/${selectedTeacherId}`, {
                onSuccess: () => {
                    setShowModal(false);
        ...
        <Adminlayout>
            <div className="container font-GenSan">
                ...
                <p className="mb-3 text-text-color-light">
                    Ini adalah tabel yang menampilkan semua data guru
                </p>
                <AddButton type="teachers" />
